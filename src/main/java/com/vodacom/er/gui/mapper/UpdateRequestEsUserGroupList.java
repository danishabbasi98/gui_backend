...
@Component
public class UpdateRequestEsUserGroupList {
    ...
    public UpdateRequestEsUserGroupList() {
    }
    ...
    public List<Groups> getEs_groupsList() {
        return _groupsList;
    }

    public void setEs_groupsList(List<Groups> _groupsList) {
        this._groupsList = _groupsList;
    }
