...
@Component
public class UpdateRequestEsUserGroup {

    private int seq;
    private int group_seq;
    private int update_group_seq;
    ...
    public UpdateRequestEsUserGroup() {
    }
    ...
    public int getUpdate_group_seq() {
        return update_group_seq;
    }

    public void setUpdate_group_seq(int update_group_seq) {
        this.update_group_seq = update_group_seq;
    }
